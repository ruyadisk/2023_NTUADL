...
def parse_args():
    ...
    parser.add_argument(
        "--train_file", type=str, default="/home/cjweibb/workspace/ntu_adl/swag.json", help="A csv or a json file containing the training data."
    )
    parser.add_argument(
